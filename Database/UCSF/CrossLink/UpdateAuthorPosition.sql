/****** Object:  StoredProcedure [Profile.Cache].[Publication.PubMed.UpdateAuthorPosition]    Script Date: 01/15/2014 11:51:59 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	*/
	...
	insert [Profile.Data].[Publication.PubMed.Author2Person] 
		select distinct personid, pmpubsauthorid from #authorid_personid 

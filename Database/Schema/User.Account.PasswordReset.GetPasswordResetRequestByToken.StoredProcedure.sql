...
CREATE PROCEDURE [User.Account].[GetPasswordResetRequestByToken] (

	@ResetToken nvarchar(255),
	@PasswordResetRequestID int OUTPUT,
	@EmailAddr nvarchar(255) OUTPUT,
...
BEGIN
	...
	BEGIN TRY	
		...
		select @PasswordResetRequestID = PasswordResetRequestId, @EmailAddr = EmailAddr, @CreateDate = CreateDate, @RequestExpireDate = RequestExpireDate, 

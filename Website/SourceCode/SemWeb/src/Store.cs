			...
			switch (type) {
				...
				case "sqlserver":
					...
					if (type == "sqlite") {
                        ...
                        //This line will only work with .Net 1.1
                        //classtype = "SemWeb.Stores.PostgreSQLStore, SemWeb.PostgreSQLStore";

                        //Had to change this string to work with .Net 2.0 or higher.
                        classtype = "SemWeb.Stores.SQLServerStore, SemWeb, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
					}

...
{
    public partial class PasswordResetConfirm : System.Web.UI.Page
    {
        ...
        {
            string presentationxml = System.IO.File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory + "/Login/PresentationXML/PasswordResetConfirmPresentation.xml");

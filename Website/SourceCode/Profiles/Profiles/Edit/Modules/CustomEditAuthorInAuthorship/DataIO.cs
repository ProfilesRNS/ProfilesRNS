    ...
    public class DataIO : Profiles.Edit.Utilities.DataIO
    {
        public bool GetDisambiguationSettings(int PersonID)
        {
            ...
            try
            {
                ...
                reader = GetDBCommand("[Profile.Data].[Publication.Pubmed.GetDisambiguationSettings]", CommandType.StoredProcedure, CommandBehavior.CloseConnection, param).ExecuteReader();
                while (reader.Read())
                {
        ...
        public void UpdateDisambiguationSettings(int PersonID, bool enabled)
        {
            ...
            try
            {
                ...
                ExecuteSQLDataCommand(GetDBCommand(ref dbconnection, "[Profile.Data].[Publication.Pubmed.UpdateDisambiguationSettings]", CommandType.StoredProcedure, CommandBehavior.CloseConnection, param));

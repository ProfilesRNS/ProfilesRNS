<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomEditEagleI.ascx.cs" Inherits="Profiles.Edit.Modules.CustomEditEagleI.CustomEditEagleI" %>
...
<asp:UpdatePanel ID="upnlEditSection" runat="server">
    <ContentTemplate>
        ...
        <table id="tblEditMentoring" width="100%">
            <tr>
                <td colspan='3'>
                         ...
                         <tr class="topRow editTable">
                            ...
                            <tr class="editTable">
                                <td style="padding: 5px 10px">
                                    <asp:Literal runat="server" ID="litEagleI"></asp:Literal>
                                </td>
                            </tr>
                        </table>
                    </div>

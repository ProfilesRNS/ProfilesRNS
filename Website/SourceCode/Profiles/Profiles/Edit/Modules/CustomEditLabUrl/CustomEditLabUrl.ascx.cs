...
namespace Profiles.Edit.Modules.CustomEditLabUrl
{
    public partial class CustomEditLabUrl : BaseModule
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["pnlEditLabUrl.Visible"] = null;
            }
            else
            {
        ...
        public CustomEditLabUrl() { }
        public CustomEditLabUrl(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        {
            if (Session["pnlEditLabUrl.Visible"] != null)
            {
                Session["pnlEditLabUrl.Visible"] = null;
                pnlEditLabUrl.Visible = false;
                pnlViewLabUrl.Visible = true;
                pnlEditButton.Visible = true;
                pnlSaveCancel.Visible = false;
            }
            else
            {
                pnlEditLabUrl.Visible = true;
                pnlViewLabUrl.Visible = false;
                pnlEditButton.Visible = false;
                pnlSaveCancel.Visible = true;
                Session["pnlEditLabUrl.Visible"] = true;
            }

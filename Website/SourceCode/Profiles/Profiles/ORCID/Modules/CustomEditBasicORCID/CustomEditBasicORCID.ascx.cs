...
{
    public partial class CustomEditBasicORCID : BaseModule
    {
        ...
        public CustomEditBasicORCID() { }
        public CustomEditBasicORCID(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)

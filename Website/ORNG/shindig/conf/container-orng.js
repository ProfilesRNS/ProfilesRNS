...
"gadgets.features" : {
  ...
  "views" : {
    ...
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "ORNG/GadgetDetails.aspx?",
      "aliases" : ["FULL_PAGE"]
    },
    "default" : {
      "isOnlyVisible" : false,
...
/*	"gadgets.rpc" : ["newBatch", "activities.supportedFields", "activities.update", "activities.delete", "activities.get", "activities.create",
	                 "gadgets.metadata", "gadgets.proxySupportedFields", "gadgets.proxy", "gadgets.cajole", "gadgets.js",
	                 "gadgets.tokenSupportedFields", "gadgets.supportedFields", "gadgets.jsSupportedFields", "gadgets.cajaSupportedFields",
	                 ...
	                 "people.getViewerFriends", "people.getOwner", "people.getOwnerFriends", "groups.get"]  */
  },
  "osapi" : {

	...
	public class ShapeRenderer implements IRenderer
	{
		...
		public function render(d:DataSprite):void
		{
			...
			switch (d.shape) {
				...
				case Shapes.BLOCK:		g.drawRect(d.u-d.x, d.v-d.y, d.w, d.h);											break;
				case Shapes.VERTICAL_BAR:	g.drawRect(-size/2, -d.h, size, d.h); 											break;
				case Shapes.HORIZONTAL_BAR:	g.drawRect(-d.w, -size/2, d.w, size);											break;
				
				case Shapes.LINE:		if (d.points!=null)		Shapes.drawLine(g, d.points);								break;
				case Shapes.CARDINAL:		if (d.points!=null)		Shapes.drawCardinal(g, d.points,d.points.length/2, 0.15, false);			break; 
				case Shapes.POLYGON:		if (d.points!=null)		Shapes.drawPolygon(g, d.points);							break;
				case Shapes.POLYBLOB:		if (d.points!=null)		Shapes.drawCardinal(g, d.points,d.points.length/2, 0.15, true);				break;

				case Shapes.WEDGE:		Shapes.drawWedge(g, d.origin.x-d.x, d.origin.y-d.y,	d.h, d.v, d.u, d.u+d.w);                                        break;
				default:			Shapes.getShape(d.shape)(g, size);
			}
